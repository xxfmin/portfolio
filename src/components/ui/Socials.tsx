      ...
      {socialLinks.map((social) => {
        ...
        return (
          <Link
            ...
            className="flex items-center justify-center p-0.5 sm:p-1 rounded-full text-sm font-medium text-muted/70 hover:text-muted transition-colors duration-300"
          >
